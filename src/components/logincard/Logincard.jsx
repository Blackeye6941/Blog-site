...
const Logincard = () => {
  return (
    <>
      <div className="flex flex-col bg-slate-300 text-black max-md:w-[60%] md:w-[50%] lg:w-[40%] xl:w-[40%] h-[51vh] mb-[20vh] mx-auto rounded-[40px]">
        ...
        <form action="">
          ...
          <button className="bg-black text-white text-[20px] px-6 max-md:mx-[70px] md:mx-[140px] lg:mx-[155px] xl:mx-[220px] rounded-xl py-2 ">Login</button>
        </form>
      </div>
    </>
  )
